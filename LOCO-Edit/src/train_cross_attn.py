...
TGT_CKPT = "diffusion_checkpoints/ddpm_chB_128/unet_ema_epoch10.pt"   #denoiser (chB)
SRC_CKPT = "diffusion_checkpoints/ddpm_chA_128/unet_ema_epoch10.pt"   #encoder  (chA)
...
for p in procs.values():
    trainable += list(p.to_k_img.parameters()) + list(p.to_v_img.parameters())
