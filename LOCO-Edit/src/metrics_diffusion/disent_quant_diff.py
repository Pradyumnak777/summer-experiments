'''
take trained diff model

1. consider the top k directions output by the locoedit method to be the "latent codes"
2. genrateive factors are same for vaes, gans and diffusion models

#NOTE: need inverted latents of all train set!!
'''
import torch
...
CKPT       = "GAN/stylegan2-ada-pytorch/training-runs/00010-data_npy-auto1-kimg1000-ada-bg/network-snapshot-001000.pkl"
...
if __name__ == "__main__":
    ...
    ax.set_title("Lasso relative importance matrix R")
    plt.tight_layout()
